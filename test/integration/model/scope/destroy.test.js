...
describe(Support.getTestDialectTeaser('Model'), () => {
  describe('scope', () => {
    describe('destroy', () => {
      ...
      (Support.getTestDialect() !== 'yugabyte' ? it : it.skip)('should be able to merge scopes with where', async function () { // Assertion Error in yugabyte
      ...
      (Support.getTestDialect() !== 'yugabyte' ? it : it.skip)('should be able to merge scopes with similar where', async function () { // Assertion Error in yugabyte
